// @restart/kv-persist-indexeddb
//
// IndexedDB implementation of the @restart/kv-persist contract. Mirrors
...
// @restart/kv-persist's correctness note).
//
...
import type { KvStorePersistence, Versioned } from '@restart/kv-persist';
